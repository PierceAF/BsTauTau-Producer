...
#    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_bphys/ytakahas/bstautau/01B61B6C-3245-824E-874A-643BAE58C6C1.root'),
                            fileNames = cms.untracked.vstring('/store/data/Run2018D/SingleMuon/MINIAOD/UL2018_MiniAODv2_GT36-v2/2810000/002DA366-9474-8C44-A757-E8D324A53783.root'),
...
process.nanoAOD_step = cms.Path(process.myTauSequence + process.nanoSequence)
...
#process.nanoAOD_step.insert(0, process.myTauCandidates + process.tauTableHad3P + process.tauTableMu3P + process.tauTableEle3P + process.tauTable3P3P)
